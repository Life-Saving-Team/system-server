...
const deletebloodRequest = require('../../../../src/data-layer/remove-bloodRequest.db')
...
describe("Users endpoint", function () {
    ...
    it("should delete bloodRequest ", async function (done) {      
        await deletebloodRequest(id, timeZoneId)
        done()
